              ...
              <tr class="text-gray-700 dark:text-gray-400">
                ...
                <td class="px-3 py-3">
                  <div class="flex items-center space-x-4 text-sm">
                    ...
                    <a href="{{route('contrasenas.decrypt', $contrasena->id)}}" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Copy">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
